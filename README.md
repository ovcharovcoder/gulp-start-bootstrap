...
- Node JS: 22.13.1 (LTS)
- Bootstrap 5: v.5.3.6.<br> У Збірці місяться файли Bootstrap 5: bootstrap.bundle.min.js та bootstrap.min.css. За потреби, нову версію можна завантажити за лінком: https://getbootstrap.com/docs/5.3/getting-started/download 
